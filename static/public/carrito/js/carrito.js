document.addEventListener('DOMContentLoaded', () => {
  ...
  async function renderCarritoDesdeAPI() {
    ...
    data.items.forEach(item => {
      ...
      div.className = 'carrito-item fade-in-carrito';
      div.dataset.varianteId = item.variante_id;
...
async function updateTotals(){
  ...
  if (!hay){
    ...
    // 👇 Oculta alertas si no hay productos
  ...
  function modalGuest(){
    ...
    m.id='guest-checkout-modal'; m.className='modal-overlay';
